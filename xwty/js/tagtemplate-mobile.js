...
+function (tag) {
    ...
    var box_content = '<div class="tag_tool_box">\
        <button type="button" class="btn btn-sm btn-default" onclick="tag.AddItem(4)"><span class="fa fa-font"></span> 文字</button>\
                                    <div class="btn-group dropdown" role="group">\
                                        <button type="button" class="btn btn-sm btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">\
                                            <span class="fa fa-rmb"></span> 价格\
                                            <span class="caret"></span>\
                                        </button>\
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="left: 0px;right:auto;border:#ddd solid 1px;">\
                                            <a class="dropdown-item" href="javascript:;" onclick="tag.AddItem(1)">完整 <small style="color:#999">如:100.99</small></a>\
                                            <a class="dropdown-item" href="javascript:;" onclick="tag.AddItem(2)">整数 <small style="color:#999">如:100</small></a>\
                                            <a class="dropdown-item" href="javascript:;" onclick="tag.AddItem(3)">小数 <small style="color:#999">如:.99</small></a>\
                                        </ul>\
                                    </div>\
                                    <div class="btn-group" role="group">\
                                        ...
                                        <ul class="dropdown-menu" style="left: 0px;right:auto;border:#ddd solid 1px;">\
                                            <a class="dropdown-item" href="javascript:;" onclick="tag.AddItem(6)"><span class="fa fa-link"></span> 网址二维码</a>\
                                            <a class="dropdown-item" href="javascript:;" onclick="tag.AddItem(7)"><span class="fa fa-shopping-bag"></span> 商品二维码</a>\
<div class="dropdown-divider"></div>\
<a class="dropdown-item" href="javascript:;" onclick="tag.AddItem(8)"><span class="fa fa-ellipsis-h"></span> 条形码</a>\
                                        </ul>\
                                    </div>\
                                    <div class="btn-group" role="group">\
                                        <button type="button" class="btn btn-sm btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">\
                                            <span class="fa fa-image"></span> 图形\
                                            <span class="caret"></span>\
                                        </button>\
                                        <ul class="dropdown-menu">\
                                            <a class="dropdown-item" href="javascript:;" onclick="tag.AddItem(5)"><span class="fa fa-image" style="color:#999"></span> 图片</a>\
                                            <div class="dropdown-divider"></div>\
                                            <a class="dropdown-item" href="javascript:;" onclick="tag.AddItem(9)"><span class="fa fa-square" style="color:#999"></span> 矩形</a>\
                                            <a class="dropdown-item" href="javascript:;" onclick="tag.AddItem(10)"><span class="fa fa-circle" style="color:#999"></span> 圆形</a>\
                                            <div class="dropdown-divider"></div>\
                                            <a class="dropdown-item" href="javascript:;" onclick="tag.AddItem(11)"><span class="fa fa-arrows-h" style="color:#999"></span> 横线</a>\
                                            <a class="dropdown-item" href="javascript:;" onclick="tag.AddItem(12)"><span class="fa fa-arrows-v" style="color:#999;padding-left:3px;padding-right:4px;"></span> 竖线</a>\
                                        </ul>\
                                    </div><div id="{0}_upload"></div>\
        </div>\
<div class="tag_preview_box">\
<img onload="tag.Preview(this.src)" style="max-width:100%" id="{0}_preview" />\
<hr style="margin-bottom:5px; margin-top:10px;"><small>尺寸：{w}*{h}</small>\
</div>\
<div class="tag_tab_box">\
                                <div id="{0}_tablistbox" style="overflow:hidden;border-bottom:#ddd solid 1px;">\
                                    <div id="{0}_tablistbox_left" class="tag_listbox_left">\
                                        <ul class="nav nav2 nav-tabs nav-tabs2" role="tablist" id="{0}_tablist" style="border-bottom: none;position:relative; display:inline-flex"></ul>\
                                    </div>\
                                    <div id="{0}_tablistbox_right" class="tag_listbox_right">\
                                        ...
                                        <div class="btn-group" role="group" aria-label="...">\
                                            <button onclick="tag.tabLeft()" id="{0}_tablistbox_btn_left" type="button" class="btn btn-sm btn-default">&nbsp;←&nbsp;</button>\
                                            <button onclick="tag.tabRight()" id="{0}_tablistbox_btn_right" type="button" class="btn btn-sm btn-default">&nbsp;→&nbsp;</button>\
                                        </div>\
                                    </div>\
                                </div>\
    ...
    var getTabByPos = function (pos) {
        $(tabcontent + " .tab-pane").each(function () {
            ...
            var img_width = $(preview).width();
            var img_height = $(preview).height();

            if (deviceType.Width > img_width) {
                width = width * (parseInt(img_width) / deviceType.Width);
                height = height * (parseInt(img_height) / deviceType.Height);
                x = x * (parseInt(img_width) / deviceType.Width);
                y = y * (parseInt(img_height) / deviceType.Height);
            }
    ...
    tag.RemoveItem = function (c) {
        lele.confirm("温馨提示：", "您确定要删除吗?", function () {
            var _parent = $(c).parent().parent().parent();
    ...
    tag.DirectRemoveItem = function (_parent, drawImage) {
        ...
        if (itemId > 0) {
            $.ajax({
                url: "/DzbqCenter/DeleteTemplateItem/" + itemId,
                type: "POST",
                dataType: "json",
                success: function (result) {
                    if (result.errorCode == 0) {
    ...
    tag.AddItem = function (type, _row) {
        ...
        $(tablist).prepend('<li class="nav-item" data-index="' + _selItem.ItemIndex + '" id="tab_row_' + _selItem.ItemIndex + '" role="presentation"><a class="nav-link" href="#row_' + _selItem.ItemIndex + '" aria-controls="row_' + _selItem.ItemIndex + '" onclick="tag.setTRow(' + _selItem.ItemIndex + ')" role="tab" data-toggle="tab">' + txt + '</a></li>');
...
<div class="tag_tools_item' + ((type == 5 || type == 7 || type == 9 || type == 10 || type == 11 || type == 12) ? " hide" : "") + '">\
    ...
    <span class="input-group-text input-group-prepend2">' + ValueStrTxt + '</span>\
  </div>\
...
<div class="tag_tools_item">\
                                                    <div class="input-group"><div class="input-group-prepend">\
                                                        <span class="input-group-text input-group-prepend2">X</span></div>\
                                                        <input name="X" value="' + _selItem.X + '" onblur="tag.DrawImage()" class="form-control" style="width:60px; text-align:center;">\
                                                        <div class="input-group-prepend"><span class="input-group-text input-group-prepend2" style="border-left:none; border-right:none;">Y</span></div>\
...
<div class="tag_tools_item' + ((type == 5 || type == 6 || type == 7 || type == 8) ? " hide" : "") + '">\
                                                    <div class="input-group">\
                                                        <div class="input-group-prepend"><span class="input-group-text input-group-prepend2">颜色</span></div>\
...
<div class="tag_tools_item' + ((type == 5 || type == 6 || type == 7 || type == 8 || type == 9 || type == 10 || type == 11 || type == 12) ? " hide" : "") + '">\
                                                    <div class="input-group">\
                                                        <div class="input-group-prepend"><span class="input-group-text input-group-prepend2">字体</span></div>\
...
<div class="tag_tools_item' + ((type == 5 || type == 6 || type == 7 || type == 8 || type == 9 || type == 10 || type == 11 || type == 12) ? " hide" : "") + '">\
                                                    <div class="input-group">\
                                                        <div class="input-group-prepend"><span class="input-group-text input-group-prepend2">样式</span></div>\
...
<div class="tag_tools_item' + ((type == 5 || type == 6 || type == 7 || type == 8 || type == 9 || type == 10 || type == 11 || type == 12) ? " hide" : "") + '">\
                                                    <div class="input-group">\
                                                        <div class="input-group-prepend"><span class="input-group-text input-group-prepend2">字号</span></div>\
                                                        <input name="FontSize" value="' + _selItem.FontSize + '" onblur="tag.DrawImage()" class="form-control" style="width:60px; text-align:center;">\
                                                    </div>\
                                                </div>\
<div class="tag_tools_item' + ((type == 5 || type == 6 || type == 7 || type == 8 || type == 9 || type == 10 || type == 11 || type == 12) ? "" : " hide") + '">\
                                                    <div class="input-group">\
                                                        <span class="input-group-prepend input-group-text input-group-prepend2">' + (type == 10 ? "直径" : "宽度") + '</span>\
...
<div class="tag_tools_item' + ((type == 5 || type == 6 || type == 7 || type == 8 || type == 9 || type == 11 || type == 12) ? "" : " hide") + '">\
                                                    <div class="input-group">\
                                                        <div class="input-group-prepend"><span class="input-group-text input-group-prepend2">高度</span></div>\
...
<div class="tag_tools_item' + (type == 9 ? "" : " hide") + '">\
                                                    <div class="input-group">\
                                                        <div class="input-group-prepend"><span class="input-group-text input-group-prepend2">圆角</span></div>\
...
<div class="tag_tools_item' + ((_selItem.DrawType == 1 && (_selItem.ItemType == 9 || _selItem.ItemType == 10)) ? "" : " hide") + '">\
                                                    <div class="input-group">\
                                                        <div class="input-group-prepend"><span class="input-group-text input-group-prepend2">边框</span></div>\
        ...
        <div class="tag_tools_item' + (type == 5 ? "" : " hide") + '"><div class="input-group">\
                                                        <button type="button" onclick="tag.SelectImage(this)" class="btn btn-sm btn-success"><span class="fa fa-image"></span> 重新选择图片</button>\
                                                </div></div>\
