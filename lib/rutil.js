...
Date.prototype.addDays = function (days) {
    var _t = this.getTime();
    var newDT = new Date().setTime(_t + days * 86400000);
    return newDT;
}
Date.prototype.addHours = function (hours) {
    var _t = this.getTime();
    var newDT = new Date().setTime(_t + hours * 3600000);
    return newDT;
}
Date.prototype.addMinutes = function (minutes) {
    var _t = this.getTime();
    var newDT = new Date().setTime(_t + minutes * 60000);
    return newDT;
}
Date.prototype.addSeconds = function (seconds) {
    var _t = this.getTime();
    var newDT = new Date().setTime(_t + seconds * 1000);
    return newDT;
}
